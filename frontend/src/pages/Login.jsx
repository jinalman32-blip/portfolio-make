    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#060d1a]">
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        ...
        >
          ...
          {/* Google Login Splitter */}
          <div className="flex items-center my-6">
            <div className="flex-1 border-t" style={{ borderColor: 'rgba(255, 255, 255, 0.1)' }}></div>
            <span className="px-3 text-gray-500 text-xs font-medium uppercase tracking-wider">Or</span>
            <div className="flex-1 border-t" style={{ borderColor: 'rgba(255, 255, 255, 0.1)' }}></div>
          </div>

          <button
            type="button"
            onClick={() => alert("Google Login needs Client ID. Please provide it from Google Console!")}
            className="w-full flex items-center justify-center gap-3 p-3 rounded-xl text-white font-medium transition-all"
            style={{ 
