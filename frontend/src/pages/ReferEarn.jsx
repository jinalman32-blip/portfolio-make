  ...
  return (
    <div className="flex h-screen bg-[#060d1a] overflow-hidden">
      ...
      <div className="flex-1 flex flex-col lg:ml-64 relative" style={{ zIndex: 1 }}>
        <Header setMobileOpen={setMobileOpen} title="Refer & Earn" />
          ...
          <div className="max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              {['Twitter', 'LinkedIn', 'WhatsApp'].map((platform, i) => (
                <button
                  key={platform}
                  className="w-full flex items-center justify-center gap-2 py-3 sm:py-2.5 rounded-xl text-sm font-medium text-gray-300 transition-all hover:text-white hover:bg-white/5"
                  style={{
                    background: 'rgba(13, 21, 38, 0.6)',
